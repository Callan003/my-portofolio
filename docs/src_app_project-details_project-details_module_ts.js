"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_project-details_project-details_module_ts"],{
...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunks/helpers.segment.js */ 4396);
/*!
 * Chart.js v3.7.0
...
/***/ 4051:
/*!*******************************************************************!*\
  !*** ./src/app/project-details/project-details-routing.module.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _project_details_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project-details.page */ 6110);
...
/***/ 1:
/*!***********************************************************!*\
  !*** ./src/app/project-details/project-details.module.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var ngx_markdown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-markdown */ 8439);
...
/* harmony import */ var _project_details_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project-details-routing.module */ 4051);
/* harmony import */ var _project_details_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project-details.page */ 6110);
...
ProjectDetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
            _project_details_routing_module__WEBPACK_IMPORTED_MODULE_1__.ProjectDetailsPageRoutingModule,
            _components_components_module__WEBPACK_IMPORTED_MODULE_0__.ComponentsModule
        ],
        declarations: [_project_details_page__WEBPACK_IMPORTED_MODULE_2__.ProjectDetailsPage],
        providers: [ngx_markdown__WEBPACK_IMPORTED_MODULE_8__.MarkdownService]
    })
...
/***/ 6110:
/*!*********************************************************!*\
  !*** ./src/app/project-details/project-details.page.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

var _assets_colors_json__WEBPACK_IMPORTED_MODULE_6___namespace_cache;
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _C_Users_Calin_Desktop_Portofolio_my_portofolio_node_modules_ngtools_webpack_src_loaders_direct_resource_js_project_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./project-details.page.html */ 3135);
/* harmony import */ var _project_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project-details.page.scss */ 7301);
/* harmony import */ var src_app_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/common */ 2953);
...
/* harmony import */ var _services_things_to_do_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../services/things-to-do.service */ 2297);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 2407);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/operators */ 2489);
/* harmony import */ var ngx_markdown__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-markdown */ 8439);
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! chart.js */ 1871);
/* harmony import */ var _assets_colors_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../assets/colors.json */ 2967);
...
let ProjectDetailsPage = class ProjectDetailsPage {
    constructor(http, route, mdService, alertController, toastController, thingsToDoService, achievementService) {
        this.http = http;
        this.route = route;
    ...
    ngOnInit() {
        this.route.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.tap)(res => this.projectName = res.projectName), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => this.http.get(`https://api.github.com/repos/Callan003/${this.projectName}`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.tap)(projectDetails => this.projectDetails = projectDetails), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => this.http.get(`https://api.github.com/repos/Callan003/${this.projectName}/readme`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.catchError)((error) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () { return console.error(error); })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.tap)((res) => {
            if (res) {
                this.readme = this.mdService.compile(atob(res === null || res === void 0 ? void 0 : res.content));
            }
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => this.http.get(`https://api.github.com/repos/Callan003/${this.projectName}/languages`))).subscribe((result) => {
            this.createPieChart(result);
        });
        this.thingsToDoService.setThingDone(2);
    }
    gitHubAchievement() {
        this.achievementService.increaseAchievementProgress(src_app_common__WEBPACK_IMPORTED_MODULE_2__.AchievementId.GITHUB);
    }
    getImageSrc(date) {
    ...
    presentToast(positiveActionClicked) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
    ...
    createPieChart(chartData) {
        ...
        labels.forEach(label => {
            randomColors.push(/*#__PURE__*/ (_assets_colors_json__WEBPACK_IMPORTED_MODULE_6___namespace_cache || (_assets_colors_json__WEBPACK_IMPORTED_MODULE_6___namespace_cache = __webpack_require__.t(_assets_colors_json__WEBPACK_IMPORTED_MODULE_6__, 2)))[label].color);
        });
...
ProjectDetailsPage.ctorParameters = () => [
    ...
    { type: ngx_markdown__WEBPACK_IMPORTED_MODULE_13__.MarkdownService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_14__.AlertController },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_14__.ToastController },
    { type: _services_things_to_do_service__WEBPACK_IMPORTED_MODULE_4__.ThingsToDoService },
    { type: _services_achievement_service__WEBPACK_IMPORTED_MODULE_3__.AchievementService }
];
ProjectDetailsPage.propDecorators = {
    pieChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_15__.ViewChild, args: ['pieChart',] }]
};
ProjectDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_15__.Component)({
        selector: 'app-project-details',
        template: _C_Users_Calin_Desktop_Portofolio_my_portofolio_node_modules_ngtools_webpack_src_loaders_direct_resource_js_project_details_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_project_details_page_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
], ProjectDetailsPage);
...
/***/ 3135:
/*!**************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/project-details/project-details.page.html ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("\n<ion-header [translucent]=\"true\" collapse=\"fade\">\n  <app-header></app-header>\n  <ion-progress-bar class='progress-bar' [value]=\"scrollPosition\" [color]=\"scrollPosition < 1 ? 'dark' : 'success'\"></ion-progress-bar>\n</ion-header>\n\n<ion-content [scrollEvents]=\"true\" (ionScroll)=\"logScrolling($event)\">\n  <ion-grid class=\"center-grid\">\n    <ion-row>\n      <ion-col>\n        <ion-card class=\"project-info-card\">\n          <ion-card-header>\n          <ion-card-title>Project info</ion-card-title>\n          </ion-card-header>\n          <ion-card-content>\n            <ion-list lines=\"none\">\n              <ion-item>\n                <ion-text slot=\"start\">Name</ion-text>\n                <ion-text slot=\"end\">{{projectName}}</ion-text>\n              </ion-item>\n              <ion-item>\n                <ion-text slot=\"start\">Created</ion-text>\n                <ion-text slot=\"end\" *ngIf=\"projectDetails\" >\n                  <ion-icon [src]=\"getImageSrc(projectDetails?.created_at)\"></ion-icon>\n                  {{projectDetails?.created_at | date: 'MMM YYYY'}}\n                </ion-text>\n                <ion-spinner slot=\"end\" name=\"bubbles\" *ngIf=\"!projectDetails\"></ion-spinner>\n              </ion-item>\n              <ion-item class=\"ion-no-margin\">\n                <ion-text slot=\"start\">Stars</ion-text>\n                <ion-text slot=\"end\" *ngIf=\"projectDetails\">\n                  {{projectDetails?.stargazers_count}} \n                  <ion-icon size=\"small\" name=\"star\" color=\"warning\"></ion-icon>\n                </ion-text>\n                <ion-spinner slot=\"end\" name=\"bubbles\" *ngIf=\"!projectDetails\"></ion-spinner>\n              </ion-item>\n              <ion-item>\n                <ion-text slot=\"start\">Watchers</ion-text>\n                <ion-text slot=\"end\" *ngIf=\"projectDetails\">\n                  {{projectDetails?.watchers_count}}\n                  <ion-icon size=\"small\" name=\"eye\" color=\"dark\"></ion-icon>\n                </ion-text>\n                <ion-spinner slot=\"end\" name=\"bubbles\" *ngIf=\"!projectDetails\"></ion-spinner>\n              </ion-item>\n              <ion-item>\n                <ion-text slot=\"start\">Forks</ion-text>\n                <ion-text slot=\"end\" *ngIf=\"projectDetails\">\n                  {{projectDetails?.forks_count}}\n                  <ion-icon size=\"small\" name=\"git-network\" color=\"dark\"></ion-icon>\n                </ion-text>\n                <ion-spinner slot=\"end\" name=\"bubbles\" *ngIf=\"!projectDetails\"></ion-spinner>\n              </ion-item>\n              <ion-item [href]=\"'https://github.com/Callan003/' + projectName\" target=\"_blank\" (click)=\"gitHubAchievement()\">\n                <ion-text slot=\"start\">Github Project Link</ion-text>\n                <ion-text slot=\"end\">\n                  <ion-icon size=\"small\" name=\"logo-github\" color=\"dark\"></ion-icon>\n                </ion-text>\n              </ion-item>\n            </ion-list>\n          </ion-card-content>\n        </ion-card>\n      </ion-col>\n      <ion-col>\n        <ion-card class=\"languages-percentage-card\">\n          <ion-card-header>\n            <ion-card-subtitle (click)=\"showDescription()\">\n              <ion-icon name=\"information-circle-outline\" size=\"large\" color=\"dark\" class=\"ion-float-right\"></ion-icon>\n            </ion-card-subtitle>\n            <ion-card-title>\n              Programming Languages\n            </ion-card-title>\n          </ion-card-header>\n          <ion-card-content>\n            <div><canvas #pieChart></canvas></div>\n          </ion-card-content>\n        </ion-card>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-card>\n          <ion-card-header>\n            <ion-card-title>ReadMe <ion-icon [name]=\"readme? 'happy-outline': 'sad-outline'\" size=\"large\" class='ion-float-right'></ion-icon></ion-card-title>\n          </ion-card-header>\n          <ion-card-content>\n            <div class='readme-data' *ngIf=\"readme\"  [innerHTML]=\"readme\"></div>\n            <div *ngIf=\"!readme\" >\n              <i>This project does not contain a 'README' file </i>\n            </div>\n          </ion-card-content>\n        </ion-card>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        \n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>\n");

/***/ }),

/***/ 7301:
/*!***********************************************************!*\
  !*** ./src/app/project-details/project-details.page.scss ***!
  \***********************************************************/
/***/ ((module) => {

module.exports = ".languages-percentage-card {\n  max-width: 500px;\n  min-width: 280px;\n  --color: var(--ion-color-dark) !important;\n}\n.languages-percentage-card ion-card-content {\n  padding: 0;\n  min-height: 300px;\n  max-width: 500px;\n}\n.languages-percentage-card ion-card-content div {\n  height: 325px;\n  width: 100%;\n  min-width: 280px;\n}\n.languages-percentage-card ion-card-header {\n  padding-bottom: 0;\n}\n.languages-percentage-card ion-card-subtitle {\n  z-index: 2;\n  cursor: pointer;\n}\n.project-info-card {\n  max-width: 500px;\n  min-width: 280px;\n}\n.project-info-card ion-icon {\n  vertical-align: text-bottom;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
//# sourceMappingURL=src_app_project-details_project-details_module_ts.js.map